...
opts$rep <- seq(1, 10)
opts$N_feat <- 300
opts$N_cells <- c(20, 50, 100, 200, 500, 1000)
opts$N_cpgs <- c(15, 50)
...
legend_pos <- list(c(0.93, 0.2), c(0.93, 0.2), c(0.93, 0.2), c(0.93, 0.8), 
                   c(0.93, 0.8), c(0.93, 0.8))
for (m in 1:length(metrics)) {
  ...
  df_res$cpgs <- factor(df_res$cpgs, levels = c(15, 50), labels = c("CpG poor", "CpG rich"))
  ...
  print(p)
  pdf(file = paste0(out_dir, "power_diffvar_", metrics[m],".pdf"), width = 10.5, height = 3.9)
  print(p)
  dev.off()
}
```
