...
if (grepl("S34-R31YLVDR",Sys.info()['nodename'])) {
  ...
  io$out_dir <- "/exports/igmm/eddie/ckapoura-XDF/scMET_analysis/data/synthetic/diff_mean/"
} else {
...
OR_change_mu <- args$oddsratio # Odds Ratio threshold
...
message("Odds Ratio threshold: ", OR_change_mu)
...
sim_dt <- readRDS(paste0(rep_dir, "data_ORmu", OR_change_mu, "_feat", N_feat,
...
saveRDS(object = obj, file = paste0(rep_dir, "/scmet_ORmu", OR_change_mu,
