...
png(sprintf("%s/scmet_hvf_hits_%s.png", io$outdir, anno_id), res = 150, width = 2300, height = 1000)
...
png(sprintf("%s/gauss_hvf_hits_%s.png", io$outdir, anno_id), res = 150, width = 2300, height = 1000)
cowplot::plot_grid(gg1, gg2, gg3, gg4, gg5, ncol = 3, nrow = 2)
dev.off()
```
...
png(sprintf("%s/disp_hvf_hits_%s.png", io$outdir, anno_id), res = 150, width = 2300, height = 1000)
cowplot::plot_grid(gg1, gg2, gg3, gg4, gg5, ncol = 3, nrow = 2)
dev.off()
```
